      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content border-0">
              ...
              <div class="col-sm-4">
                <div class="mb-2">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="主要圖片連結" v-model="localProduct.imageUrl">
                  </div>
                ...
                <div v-if="Array.isArray(localProduct.imagesUrl)">
                  <div class="mb-3" v-for="(img, key) in localProduct.imagesUrl" :key="key">
                    <div class="mb-2">
                      <label :for="'imageUrl' + key" class="form-label">圖片網址</label>
                      <input type="text" class="form-control" :id="'imageUrl' + key" v-model="localProduct.imagesUrl[key]" placeholder="圖片連結" >
                    </div>
                    <img class="img-fluid" :src="img" alt="">
                  </div>
                  <div v-if="!localProduct.imagesUrl.length || localProduct.imagesUrl.at(-1)">
                    <button class="btn btn-outline-primary btn-sm d-block w-100" @click="addImage">
                      新增圖片
                    </button>
                  </div>
                  <div v-else>
                    <button class="btn btn-outline-danger btn-sm d-block w-100" @click="localProduct.imagesUrl.pop()">
                      刪除圖片
                    </button>
                  </div>
                </div>
              ...
              <div class="col-sm-8">
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="category" type="text" class="form-control" placeholder="請輸入分類" v-model="localProduct.category">
                  </div>
                  <div class="mb-3 col-md-6">
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input id="origin_price" type="number" min="0" class="form-control"
                      placeholder="請輸入原價" v-model="localProduct.origin_price">
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="price" class="form-label">售價</label>
                    <input id="price" type="number" min="0" class="form-control" placeholder="請輸入售價"  v-model="localProduct.price">
                  </div>
                  <div class="mb-3 col-md-6">

                    <pre>localProduct -  {{localProduct}}</pre>
                ...
                <div class="mb-3">
                  ...
                  <textarea id="description" type="text" class="form-control" placeholder="請輸入產品描述" v-model="localProduct.description"></textarea>
                </div>
                <div class="mb-3">
                  <label for="content" class="form-label">說明內容</label>
                  <textarea id="content" type="text" class="form-control" placeholder="請輸入說明內容" v-model="localProduct.content"></textarea>
                </div>
                <div class="mb-3">
                  <div class="form-check">
                    <input id="is_enabled" class="form-check-input" type="checkbox" :true-value="1" :false-value="0" v-model="localProduct.is_enabled">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="updateProduct(localProduct)">
              確認
            </button>
          </div>
        </div>
